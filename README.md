![Dr. Dave Wanik — Associate Professor In-Residence, University of Connecticut](hero.svg)
...
<sub>Major courses (5+ students); multiple sections of a course combined. Deep Learning has run since 2019: first as OPIM 5894 (special topics), then as OPIM 5509.</sub>
...
<sub>📍 School of Business, University of Connecticut — Stamford campus · Everything on this page (books, notebooks, code) is open — use it, fork it, learn from it.</sub>
